...
public class Fight {
    ...
    public static void main(String[] args) {
        ...
        Fighter f1 = new Fighter("Hans-Dieter", "Polizei", 155.7, 30, 20, 60, 80, 40);
        ...
        for (int i= 0; i<fighters.length; i++){
            System.out.println(fighters[i].name + ", choose your Weapon! These are available:");
        ...
        for (int i= 0; i<fighters.length; i++){
            System.out.println(fighters[i].name + ", choose your preparation for the next fight. You can choose if you want to eat, sleep, train with a weapon or go fishing.");
            for (int j=0; j<preparation; j++){
                System.out.println("Round " + j+1 + " of " + preparation + "\t\t(Your current status is:\t" + fighters[i].getStats() + ")");
